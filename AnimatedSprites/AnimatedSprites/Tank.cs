...
namespace AnimatedSprites
{
    ...
    abstract class Tank : Sprite
    {
        ...
        public Vector2 GetMissileStartPosition()
        {
            ...
            {
                case Direction.Up:
                    missileStartPosition.X = position.X + Settings.FrameSize.X / 2 * SpriteSettings.Scale - MissileSetting.FrameSize.X / 2 * SpriteSettings.Scale;
                    missileStartPosition.Y = position.Y - MissileSetting.FrameSize.Y;
                    break;
                case Direction.Left:
                    missileStartPosition.X = position.X - MissileSetting.FrameSize.X;
                    missileStartPosition.Y = position.Y + Settings.FrameSize.Y / 2 * SpriteSettings.Scale - MissileSetting.FrameSize.Y / 2 * SpriteSettings.Scale;
                    break;
